  ...
  module SamlSettings
    class << self
      def values
        ...
        acs_url = ENV['ASSERTION_CONSUMER_SERVICE_URL'] || 'https://localhost:3000/users/saml/auth'
        ...
        saml_settings.issuer = ENV['ISSUER'] || 'https://localhost:3000/users/saml/metadata'
        ...
        idp_sso_url = ENV['IDP_SSO_TARGET_URL'] || 'https://localhost:3030/idp/saml/auth'
        saml_settings.idp_sso_target_url = idp_slo_target_url
